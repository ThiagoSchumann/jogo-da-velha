...
function TFrmPrincipal.VerificaVitoria2: Boolean;
   ...
   function VerificaVitoriaColunas: Boolean;
   var
      row, col, jogadorAnterior: integer;
   begin
      // inicializa o resultado da função com zero; 
      result := False;
      // percorre as linhas 
      ...
      begin
         ...
         begin
            ...
            begin
               // caso estiber na primeira colula a variável jogadorAnterior recebe a posição atual 
               if row = 0 then
                  jogadorAnterior := Matriz[col][row];
               // Caso o valor do campo atual ser diferente do anterior, significa que não temos uma sequencia perfeita 
               if Matriz[col][row] <> jogadorAnterior then
               begin
                  // Retorno recebe False e saí do laço 
                  result := False;
                  Break;
   ...
   function VerificaDiagolal1: Boolean;
   var
      row, jogadorAnterior: integer;
   begin
      // inicializa o resultado da função com zero; 
      result := False;
      // percorre as linhas 
      ...
      begin
         ...
         result := True;
         // caso o valor do campo seja 100, significa que é um campo livre no tabuleiro 
         if Matriz[row][row] <> 100 then
         begin
            // caso estiver na primeira colula a variável jogadorAnterior recebe a posição atual 
            if row = 0 then
               jogadorAnterior := Matriz[row][row];
            // Caso o valor do campo atual ser diferente do anterior, significa que não temos uma sequencia perfeita 
            if Matriz[row][row] <> jogadorAnterior then
            begin
               // Retorno recebe False e saí do laço 
               result := False;
               Break;
   ...
   function VerificaDiagolal2: Boolean;
   var
      row, jogadorAnterior, aux: integer;
   begin
      // inicializa o resultado da função com zero; 
      result := False;
      aux := -1;
      ...
      begin
         ...
         result := True;
         // caso o valor do campo seja 100, significa que é um campo livre no tabuleiro 
         if Matriz[row][IntCasas - aux] <> 100 then
         begin
            // caso estiver na primeira colula a variável jogadorAnterior recebe a posição atual 
            if row = 0 then
               jogadorAnterior := Matriz[row][IntCasas - aux];
            // Caso o valor do campo atual ser diferente do anterior, significa que não temos uma sequencia perfeita 
            if Matriz[row][IntCasas - aux] <> jogadorAnterior then
            begin
               // Retorno recebe False e saí do laço 
               result := False;
               Break;
...
begin
   result := VerificaVitoriaLinhas or VerificaVitoriaColunas or VerificaDiagolal1 or VerificaDiagolal2;
end;
